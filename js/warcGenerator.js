...
function generateWarc (o_request, o_sender, f_callback) {
  ...
  // DUCTTAPE to fix bug #53, we should do this.
  ...
  var warcResponseHeader = makeWarcResponseHeaderWith(initURI, now, warcConcurrentTo, warcResponse, 0)
  ...
  var arrayBuffers = [] // Load all data in-order in the arrayBuffers array then combine with the file blob to writeout
